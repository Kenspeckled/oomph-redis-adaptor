    ...
    return getOriginalObjPromise.then(function(originalObj) {
      ...
      multiPromise = new Promise(function(resolve, reject) {
        return multi.exec(function() {
          var findPromise;
          findPromise = sendAttributesForSaving.apply(self, [updateFieldsDiff, skipValidation]).then(function(writtenObj) {
            return self.find(writtenObj.id);
          });
          return findPromise.then(function(found) {
