    ...
    return getOriginalObjPromise.then(function(originalObj) {
      ...
      multiPromise = new Promise(function(resolve, reject) {
        return multi.exec(function() {
          var findPromise;
          return findPromise = sendAttributesForSaving.apply(self, [updateFieldsDiff, skipValidation]).then(function(writtenObj) {
            return resolve(redisFind.apply(self, [writtenObj.id]));
          });
        });
      });
