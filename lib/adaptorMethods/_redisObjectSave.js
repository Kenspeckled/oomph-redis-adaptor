...
(function() {
  var Promise, _, _oomphRedisObjectSaveQueueCallbacks, _utilities, addToWriteQueue, clearUniqueQueuedIds, generateId, generateUniqueId, indexSearchableString, indexSortedSet, numberOfExtraCharactersOnId, oomph, performValidations, processWriteQueue, sendAttributesForSaving, writeAttributes,
    slice = [].slice;
  ...
  clearUniqueQueuedIds = function() {
    return this.redis.del(this.className + '#uniqueQueuedIds');
  };
