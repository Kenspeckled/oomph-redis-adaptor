...
(function() {
  ...
  performValidations = function(validateFields, dataFields) {
    ...
    returnedValidations = _.map(validateFields, (function(_this) {
      return function(attrName) {
        var attrObj, attrValue;
        attrObj = _this.classAttributes[attrName];
  ...
  sendAttributesForSaving = function(dataFields, skipValidation) {
    var attrs, isNewObject, props, sanitisedDataFields, validationPromise;
    if (skipValidation) {
      ...
      if (isNewObject) {
        attrs = ['id'].concat(_.keys(this.classAttributes));
      } else {
    ...
    return validationPromise.then((function(_this) {
      return function() {
        return writeAttributes.apply(_this, [props]);
      };
    })(this));
  };
