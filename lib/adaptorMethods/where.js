...
(function() {
  ...
  where = function(args) {
    ...
    args.sortDirection || (args.sortDirection = 'desc');
    ...
    if (args.sortBy === 'random') {
      ...
      end = args.offset > 0 ? (args.offset + 1) * -1 : -1;
